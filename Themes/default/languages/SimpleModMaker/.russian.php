...
$txt['smm_hooks_subtext'] = 'Все указанные вами хуки будут сохраняться в базе данных для быстрого доступа при создании новых проектов. Список всех хуков можно посмотреть <a class="bbc_link" href="https://dragomano.ru/hooks">здесь</a>.';
